...
import com.json.basewebview.Web.BaseUrlBean;
import com.json.basewebview.Web.WebStringUtils;
...
public abstract class BaseNoTitleWebFragment<T extends BaseJsInterface> extends RxFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = View.inflate(mActivity, R.layout.frag_web_base_notitle, null);
        initView();
        return rootView;
    }
