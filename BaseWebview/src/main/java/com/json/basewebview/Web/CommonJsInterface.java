...
public class CommonJsInterface extends BaseJsInterface {
    protected CommonJsCallBack mCallBack;
    protected BaseNoTitleWebFragment rootFragment;

    public CommonJsInterface(BaseNoTitleWebFragment baseWebFragment, CommonJsCallBack mCallBack) {
    ...
    public interface CommonJsCallBack {
